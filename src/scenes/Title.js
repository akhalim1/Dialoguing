class Title extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.image("luffy", "img/luffy.png");
  ...
  create() {
    // add title text
    this.add
      .bitmapText(centerX, centerY - 32, "singtton_font", "THE ODYSSEY", 32)
      .setOrigin(0.5);
    this.add
      .bitmapText(centerX, centerY, "singtton_font", "Press SPACE to start", 16)
      .setOrigin(0.5);
