class Talking extends Phaser.Scene {
  ...
  init() {
    ...
    this.DBOX_FONT = "singtton_font"; // dialog box font key
  ...
  create() {
    ...
    this.dialogbox = this.add
      .sprite(this.DBOX_X, this.DBOX_Y, "dialogbox")
      .setOrigin(0);
    ...
    this.homer = this.add
      .sprite(this.OFFSCREEN_X, this.DBOX_Y + 8, "homer")
      .setOrigin(0, 1);
    this.minerva = this.add
      .sprite(this.OFFSCREEN_X, this.DBOX_Y + 8, "minerva")
      .setOrigin(0, 1);
    this.neptune = this.add
      .sprite(this.OFFSCREEN_X, this.DBOX_Y + 8, "neptune")
      .setOrigin(0, 1);
    this.jove = this.add
      .sprite(this.OFFSCREEN_X, this.DBOX_Y + 8, "jove")
      .setOrigin(0, 1);

    this.luffy = this.add
      .sprite(this.OFFSCREEN_X, this.DBOX_Y + 8, "luffy")
      .setOrigin(0, 1);
  ...
  typeText() {
    ...
    if (this.dialogConvo >= this.dialog.length) {
      ...
      this.combinedDialog =
        this.dialog[this.dialogConvo][this.dialogLine][
          "speaker"
        ].toUpperCase() +
        ": " +
